...
const entries: TimelineEntry[] = [
  ...
  },
  {
    ...
    subtitle: "AI Data Annotator & Content Moderator",
    tags: ["DataQuality", "AI Training", "Compliance"],
  },
  {
    year: "2024",
    title: "ITS Olivetti, Cesena",
    subtitle: "Senior Technician in DevOps",
    description: "Graduating September 2025.",
    tags: ["DevOps", "Cloud", "CI/CD", "Linux"],
  },
  {
    year: "2025",
    title: "FlashStart",
  ...
  },
  {
    ...
    subtitle: "AI Productivity Specialist",
    subtitle2: "Intern @Onit Spa AI Division",
        ...
        {entries.map((entry, i) => (
          <div key={i} className="flex items-center shrink-0">
            ...
            >
              ...
              {entry.subtitle2 && (
                <p className="text-xs text-muted-foreground mb-1 mt-0">
                  {entry.subtitle2}
                </p>
              )}
              {entry.description && (
