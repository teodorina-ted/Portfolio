...
const projects = [
  ...
  title: "DataPrep",
  previewUrl: "https://teodorina-ted-dataprep.vercel.app/",
  business:
    "A full-stack data preparation platform built during my recent AI internship. Addresses the bottleneck of manual data cleaning in ML pipelines — where inconsistent formats, missing values, and schema drift slow down every downstream process.",
  ...
  websiteUrl: "https://teodorina-ted-dataprep.vercel.app/",
